...
/* package Hangman-Game-0.1.0.0 */
#ifndef VERSION_Hangman_Game
#define VERSION_Hangman_Game "0.1.0.0"
#endif /* VERSION_Hangman_Game */
#ifndef MIN_VERSION_Hangman_Game
#define MIN_VERSION_Hangman_Game(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Hangman_Game */
...
#define CURRENT_COMPONENT_ID "Hangman-Game-0.1.0.0-inplace-Hangman-Game"
